    ...
    return (
        <>
            <aside className="w-64 h-screen" aria-label="Sidebar">
                <div className="overflow-y-auto py-4 px-3 bg-white dark:bg-gray-600 h-screen">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <button
                                ...
                                aria-controls="billing-dropdown"
                                data-collapse-toggle="billing-dropdown"
                            >
                                <svg
                            ...
                            <ul id="billing-dropdown" className="hidden py-2 space-y-2">
                                <li>
                                    <a
                                        href="#"
                        ...
                        <li>
                            ...
                            <ul id="user-dropdown" className="hidden py-2 space-y-2">
                                <li>
                                    <a
                                        href="#"
                                        className="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
